$(document).ready(function() {
	...
	$("#arrival_date").datepicker({
        maxDate:'+90d', /*from current date to 90days*/
        minDate: '+0d',/*current date */
	...
	// the handler for the View Cancellation policy event of the form
	// executed when the View Cancellation policy button is clicked
